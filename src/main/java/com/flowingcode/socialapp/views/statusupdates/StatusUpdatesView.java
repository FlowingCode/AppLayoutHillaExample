package com.flowingcode.socialapp.views.statusupdates;
...
@Route(value = "forum")
@RouteAlias(value = "")
public class StatusUpdatesView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public StatusUpdatesView() {
        addClassName("status-updates-view");
        setSizeFull();
        grid.setHeight("100%");
